...
void Load_Demo_Screens(void)
{
	...
	strcpy(screens[10][0], "F\x02" "Y\2" "C\x0B" "How was our\xFF" "Y\x16" "C\x0E" "service today?\xFF"
			              ...
			              "X\x68" "Y\x2D" "B\x5A\x32" "X\x69" "Y\x2E" "B\x5A\x32" "ES");
	strcpy(screens[11][0], "F\x03" "Y\x05" "C\x11" "Push here if this\xFF" "Y\x20" "C\x11" "spot welder needs\xFF"
	                      "Y\x3D" "C\x09" "attention\xFF" "ES");
	strcpy(screens[12][0], "F\x02" "Y\x0E" "l\x04" "Push\xFF" "Y\x24" "l\x08" "left for\xFF"
	 		               ...
	 		               "X\x02" "Y\x02" "B\x5A\x5C" "X\x03" "Y\x03" "B\x58\x5A"
	           	  	  	   "X\x68" "Y\x02" "B\x5A\x5C" "X\x69" "Y\x03" "B\x58\x5A"
	 		               "ES");
	strcpy(screens[13][0], "F\x03" "Y\x05" "C\x0F" "A repairer will\xFF" "Y\x20" "C\x13" "attend this machine\xFF"
	                      "Y\x3D" "C\x11" "by 10:30, Tuesday\xFF" "ES");
	strcpy(screens[14][0], "F\x02" "Y\x0E" "l\x09" "Push left\xFF" "Y\x24" "l\x0A" "if you are\xFF"
	 		               ...
	 		               "X\x02" "Y\x02" "B\x5A\x5C" "X\x03" "Y\x03" "B\x58\x5A"
	           	  	  	   "X\x68" "Y\x02" "B\x5A\x5C" "X\x69" "Y\x03" "B\x58\x5A"
	 		               "ES");
	strcpy(screens[15][0], "F\x03" "Y\x05" "C\x0C" "Push here to\xFF" "Y\x20" "C\x0A" "order more\xFF"
	                      "Y\x3D" "C\x09" "batteries\xFF" "ES");
	strcpy(screens[16][0], "F\x03" "Y\x0E" "l\x04" "Push\xFF" "Y\x24" "l\x08" "left for\xFF"
	 		               "Y\x3C" "l\x02" "AA\xFF" "Y\x0E" "r\x04" "Push\xFF" "Y\x24"
	 		               "r\x09" "right for\xFF" "Y\x3C" "r\x03" "AAA\xFF"
	 		               "X\x02" "Y\x02" "B\x5A\x5C" "X\x03" "Y\x03" "B\x58\x5A"
	           	  	  	   "X\x68" "Y\x02" "B\x5A\x5C" "X\x69" "Y\x03" "B\x58\x5A"
	 		               "ES");
	...
	strcpy(screens[22][0], "F\x03" "Y\x05" "C\x0F" "Push to request\xFF" "Y\x22" "C\x13" "an AV technician in\xFF"
	    		           "Y\x3D" "C\x0E" "meeting room 1\xFF" "ES");
	strcpy(screens[23][0], "F\x03" "Y\x10" "C\x0D" "AV technician\xFF" "Y\x32" "C\x09" "requested\xFF" "ES");
	strcpy(screens[24][0], "F\x03" "Y\x05" "C\x05" "An AV\xFF" "Y\x20" "C\x0D" "technician is\xFF"
			               "Y\x3D" "C\x0C" "on their way\xFF" "ES");
	strcpy(screens[25][0], "F\x03" "Y\x10" "C\x0C" "Push here if\xFF" "Y\x32" "C\x09" "you're OK\xFF" "ES");
	strcpy(screens[26][0], "F\x03" "Y\x05" "C\x0C" "Thanks. I'll\xFF" "Y\x20" "C\x0D" "call you this\xFF" "Y\x3D" "C\x0A" "PM - Peter\xFF" "ES");
	strcpy(screens[27][0], "F\x03" "Y\x05" "C\x0C" "Push here to\xFF" "Y\x20" "C\x0C" "request more\xFF"
	      		           "Y\x3D" "C\x0F" "coffee capsules\xFF" "ES");
	strcpy(screens[28][0], "F\x03" "Y\x05" "C\x0B" "More coffee\xFF" "Y\x20" "C\x0D" "capsules have\xFF"
	      		           "Y\x3D" "C\x0E" "been requested\xFF" "ES");
	strcpy(screens[29][0], "F\x03" "Y\x05" "C\x0C" "Push here if\xFF" "Y\x20" "C\x10" "you want a carer\xFF"
	       		           "Y\x3D" "C\x0C" "to visit you\xFF" "ES");
	strcpy(screens[30][0], "F\x03" "Y\x10" "C\x0C" "Your request\xFF" "Y\x32" "C\x0D" "has been sent\xFF" "ES");
	strcpy(screens[31][0], "F\x03" "Y\x05" "C\x0C" "A carer will\xFF" "Y\x20" "C\x11" "visit you between\xFF"
	         		       "Y\x3D" "C\x0F" "11:00 and 12:00\xFF" "ES");
	strcpy(screens[32][0], "F\x02" "Y\x05" "C\x0C" "Push here if\xFF" "Y\x20" "C\x10" "printer supplies\xFF"
	        		       "Y\x3D" "C\x07" "are low\xFF" "ES");
	strcpy(screens[33][0], "F\x02" "Y\x0E" "l\x04" "Push\xFF" "Y\x24" "l\x08" "left for\xFF"
	...
	strcpy(screens[34][0], "F\x02" "Y\x0E" "l\x04" "Push\xFF" "Y\x24" "l\x08" "left for\xFF"
	            	  	   ...
	            	  	   "X\x68" "Y\x02" "B\x5A\x5C" "X\x69" "Y\x03" "B\x58\x5A"
	  		               "ES");
	strcpy(screens[35][0], "F\x02" "Y\x04" "C\x0F" "Low black toner\xFF" "Y\x1A" "C\x08" "reported\xFF"
	 		               "Y\x30" "C\x12" "Push here if other\xFF" "Y\x46" "C\x14" "printer supplies low\xFF" "ES");
	strcpy(screens[36][0], "F\x03" "Y\x10" "C\x0C" "Push here if\xFF" "Y\x32" "C\x0D" "you need help\xFF" "ES");
	for(s=0; s<37; s++)
		for(i=0; i<128; i++)
			if(screens[s][0][i] == 0xFF)
				screens[s][0][i] = 0x00;
